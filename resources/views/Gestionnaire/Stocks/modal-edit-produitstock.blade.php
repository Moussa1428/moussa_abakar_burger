            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('produits.updatestock', $product->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <a type="button" href="{{ route('admin.stocks') }}" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</a>
                        </form>
                    </div>
                </div>
            </div>
